...
public class Sudoku {   
   ...
   private boolean[][] isrowHasVal;
   private boolean[][] iscolHasVal;
   ...
   public Sudoku() {
       ...
       this.isrowHasVal = new boolean[9][10];
       this.iscolHasVal = new boolean[9][10];   
   ...
   public void placeVal(int val, int row, int col) {
       ...
       if(val != 0){
           ...
           this.isrowHasVal[row][val] = true;
           this.iscolHasVal[col][val] = true;
       }
    } 
   ...
   public void removeVal(int val, int row, int col) {
       ...
       if(val != 0){
           ...
           this.isrowHasVal[row][val] = false;
           this.iscolHasVal[col][val] = false;
       }
   ...
   private boolean solveRB(int n) {
       ...
       for(int i = 1; i <= 9; i++){
           if(this.iscolHasVal[col][i] == false && this.isrowHasVal[row][i] == false && this.subgridHasVal[row/3][col/3][i] == false){
